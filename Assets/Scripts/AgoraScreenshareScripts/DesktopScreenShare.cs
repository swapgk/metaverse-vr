...
public class DesktopScreenShare : PlayerViewControllerBase
{
    ...
    {
        Debug.Log("DesktopScreenShare-> SetupUI");
        ...
        if (button != null)
        {
            ...
            button.onClick.AddListener(RemoveVideoFromMainDisplay);
    ...
    void AddVideoToMainDisplay()
    {
        // GameObject quad = GameObject.Find("MainScreen");
        // if (ReferenceEquals(quad, null))
        // {
        //     Debug.Log("Error: failed to find DisplayPlane");
        //     return;
        ...
        // else
        // {
        //     VideoSurface vs = quad.GetComponent<VideoSurface>();
        ...
        //     }
        // }
        MainScreenScript.AddVideoToMainDisplay_();
    }

    void RemoveVideoFromMainDisplay()
    {
        // GameObject quad = GameObject.Find("MainScreen");
        // if (ReferenceEquals(quad, null))
        // {
        ...
        //     vs.enabled = false;
        // }
        MainScreenScript.RemoveVideoFromMainDisplay_();
    }

    int displayID0or1 = 0;
    void ShareDisplayScreen()
    {
        AddVideoToMainDisplay();

        Debug.Log("DesktopScreenShare-> ShareDisplayScreen");
    ...
    {   
        Debug.Log("DesktopScreenShare-> OnShareWindowClick");
        AddVideoToMainDisplay();
        char[] delimiterChars = { '|' };
        ...
        Debug.LogWarning("DesktopScreenShare:" + wid + " is chosen");
        mRtcEngine.StopScreenCapture();
